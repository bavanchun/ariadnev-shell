...
import (
	...
	"github.com/bavanchun/ariadnev-shell/core/internal/colorpicker"
...
Examples:
  advs color pick                # Pick color, output as hex
  advs color pick --rgb          # Output as RGB
  advs color pick --json         # Output all formats as JSON
  advs color pick --hex -l       # Output hex in lowercase
  advs color pick -a             # Auto-copy result to clipboard`,
	Run: runColorPick,
}
