...
Examples:
  advs notify "Hello" "World"
  advs notify "File received" "photo.jpg" --file ~/Downloads/photo.jpg --icon smartphone
  advs notify "Download complete" --file ~/Downloads/file.zip --app "My App"`,
...
func init() {
	notifyCmd.Flags().StringVar(&notifyAppName, "app", "ADVS", "Application name")
