...
const (
	cliPolicyPackagedPath = "/usr/share/advs/cli-policy.json"
	cliPolicyAdminPath    = "/etc/advs/cli-policy.json"
)
...
func normalizeCommandSpec(raw string) string {
	...
	normalized = strings.TrimPrefix(normalized, "advs ")
...
// $ADVS_PRIVESC env var isn't set).
