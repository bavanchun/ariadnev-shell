...
Examples:
  advs chroma main.go
  advs chroma --language python script.py
  echo "def foo(): pass" | advs chroma -l python
  cat code.rs | advs chroma -l rust --style dracula
  advs chroma --markdown README.md
  advs chroma --markdown --style github-dark notes.md
  advs chroma list-languages
  advs chroma list-styles`,
