...
var registryCmd = &cobra.Command{
	...
	Long:  "Manage the registries ADVS fetches plugins and themes from. The official registry is always active; additional registries can be added by name and git URL.",
}
