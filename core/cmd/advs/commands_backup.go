...
import (
	...
	"github.com/bavanchun/ariadnev-shell/core/internal/backup"
...
var backupCmd = &cobra.Command{
	Use:   "backup",
	Short: "Backup and restore ADVS configuration",
}

var backupCreateCmd = &cobra.Command{
	Use:   "create",
	Short: "Create a tar.gz backup of ~/.config/AriadnevShell (settings, plugins, themes)",
	Args:  cobra.NoArgs,
	Run:   runBackupCreate,
}
...
var backupRestoreCmd = &cobra.Command{
	Use:   "restore <archive>",
	Short: "Restore a ADVS configuration backup; the current configuration is moved aside first",
	Args:  cobra.ExactArgs(1),
	Run:   runBackupRestore,
}

func init() {
	backupCreateCmd.Flags().StringVarP(&backupOutputPath, "output", "o", "", "Output archive path (default advs-backup-<timestamp>.tar.gz)")
