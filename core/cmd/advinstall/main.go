...
import (
	...
	"github.com/bavanchun/ariadnev-shell/core/internal/headless"
...
var rootCmd = &cobra.Command{
	Use:   "advinstall",
	Short: "Install AriadnevShell and its dependencies",
	Long: `advinstall sets up AriadnevShell with your chosen compositor and terminal.
...
func main() {
	if os.Getuid() == 0 {
		fmt.Fprintln(os.Stderr, "Error: advinstall must not be run as root")
		os.Exit(1)
	}
...
func runAdvinstall(cmd *cobra.Command, args []string) error {
