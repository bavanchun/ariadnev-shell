...
This guide covers creating custom themes for AriadnevShell. You can define your own color schemes by creating theme files that the shell can load.
...
You can also edit `~/.config/AriadnevShell/settings.json` manually
