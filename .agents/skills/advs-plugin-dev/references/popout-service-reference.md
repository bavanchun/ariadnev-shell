...
The `PopoutService` singleton lets plugins control all ADVS popouts and modals. It is automatically injected into widget, daemon, and settings components.
...
| Launcher | `openAdvLauncherV2()` | `closeAdvLauncherV2()` | Also has `toggleAdvLauncherV2()` |
...
- `AriadnevShell.qml` - daemon plugins
