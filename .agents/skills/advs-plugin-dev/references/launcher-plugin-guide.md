...
Launcher plugins extend the ADVS launcher with custom searchable items and actions. They use trigger-based filtering and integrate directly into the app drawer.
...
function executeItem(item) {
    ...
    switch (actionType) {
        case "toast":
            ...
            break
        case "copy":
            Quickshell.execDetached(["advs", "cl", "copy", actionData])
