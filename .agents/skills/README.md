...
| Skill | Description |
|-------|-------------|
| [advs-plugin-dev](advs-plugin-dev/) | Develop plugins for AriadnevShell - covers all 4 plugin types (widget, daemon, launcher, desktop), manifest creation, QML components, settings UI, data persistence, theme integration, and PopoutService usage. |
...
ln -s ../../.agents/skills/advs-plugin-dev .claude/skills/advs-plugin-dev
```

**Personal** (all your projects):

```bash
ln -s /path/to/AriadnevShell/.agents/skills/advs-plugin-dev ~/.claude/skills/advs-plugin-dev
```

After linking, the skill appears in Claude Code's `/` menu as `/advs-plugin-dev`, and Claude loads it automatically when you ask about ADVS plugin development.
...
ln -s ../../.agents/skills/advs-plugin-dev .cursor/skills/advs-plugin-dev
```
...
ln -s ../../.agents/skills/advs-plugin-dev .github/skills/advs-plugin-dev
```
...
ln -s ../../.agents/skills/advs-plugin-dev .gemini/skills/advs-plugin-dev
```
...
ln -s ../../.agents/skills/advs-plugin-dev .codex/skills/advs-plugin-dev
```
...
ln -s ../../.agents/skills/advs-plugin-dev .<agent>/skills/advs-plugin-dev
```
