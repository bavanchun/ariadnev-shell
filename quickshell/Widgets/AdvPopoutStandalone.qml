...
Item {
    ...
    readonly property var log: Log.scoped("AdvPopoutStandalone")
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("ADVS_DISABLE_LAYER") !== "true" && Quickshell.env("ADVS_DISABLE_LAYER") !== "1" && !(root.suspendShadowWhileResizing && root._resizeActive)
                    }
