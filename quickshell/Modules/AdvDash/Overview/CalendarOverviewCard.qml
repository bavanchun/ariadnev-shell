...
Rectangle {
    ...
    Column {
        ...
        Rectangle {
            id: advWarning
            width: parent.width
            readonly property bool showWarning: CalendarService?.advNeedsLaunch ?? false
            visible: showWarning
            ...
            Row {
                ...
                AdvButton {
                    id: launchButton
                    anchors.verticalCenter: parent.verticalCenter
                    visible: CalendarService && CalendarService.advBinaryExists
                    text: I18n.tr("Launch")
                    buttonHeight: 26
            ...
            Item {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        readonly property bool isAdvTask: taskId.startsWith("vtodo_")
                        readonly property bool isTask: isLocalTask || isAdvTask
                        readonly property bool canModify: isLocalTask || (isAdvTask && modelData && !modelData.readOnly)
                        ...
                        Column {
                            ...
                            anchors.right: parent.right
                            anchors.verticalCenter: parent.verticalCenter
                            anchors.leftMargin: taskItem.isLocalTask ? 60 : taskItem.isAdvTask ? 36 : (Theme.spacingS + 6)
