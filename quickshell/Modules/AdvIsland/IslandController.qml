...
QtObject {
    ...
    readonly property bool homeCompactTight: SettingsData.advIslandHomeCompactTight
    ...
    readonly property bool homeNotificationBadge: SettingsData.advIslandHomeNotificationBadge && unreadNotificationCount > 0
    ...
    readonly property string homeMediaSlot: resolvedHomeSlot(SettingsData.advIslandHomeMediaSlot, "left")
    readonly property string homeStatusSlot: resolvedHomeSlot(SettingsData.advIslandHomeStatusSlot, "hidden")
    readonly property string homeWeatherSlot: SettingsData.weatherEnabled ? resolvedHomeSlot(SettingsData.advIslandHomeWeatherSlot, "hidden") : "hidden"
