...
Singleton {
    ...
    readonly property bool rememberLastSession: GreetdEnv.readBoolOverride(Quickshell.env, ["ADVS_GREET_REMEMBER_LAST_SESSION", "ADVS_SAVE_SESSION"], true)
    readonly property bool rememberLastUser: GreetdEnv.readBoolOverride(Quickshell.env, ["ADVS_GREET_REMEMBER_LAST_USER", "ADVS_SAVE_USERNAME"], true)
