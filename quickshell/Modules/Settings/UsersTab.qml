    ...
    AdvFlickable {
        ...
        Column {
            ...
            SettingsCard {
                ...
                StyledText {
                    width: parent.width
                    text: I18n.tr("Greeter group members can sync their login-screen theme with advs-greeter sync --profile after logging out and back in.")
                    font.pixelSize: Theme.fontSizeSmall
                    color: Theme.surfaceVariantText
                    wrapMode: Text.Wrap
                }
                                ...
                                AdvActionButton {
                                    ...
                                    onClicked: {
                                        ...
                                        greeterToggleConfirm.showWithOptions({
                                            ...
                                            message: enableGreeter ? I18n.tr("Add \"%1\" to the %2 group? They must log out and back in, then run advs-greeter sync --profile to publish their login-screen theme.").arg(userRow.modelData.username).arg(UsersService.greeterGroup) : I18n.tr("Remove \"%1\" from the %2 group?").arg(userRow.modelData.username).arg(UsersService.greeterGroup),
            ...
            SettingsCard {
                ...
                SettingsToggleRow {
                    ...
                    description: I18n.tr("Add the new user to the %1 group so they can run advs-greeter sync --profile.").arg(UsersService.greeterGroup)
