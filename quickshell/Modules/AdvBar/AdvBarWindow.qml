...
PanelWindow {
    id: barWindow
    readonly property var log: Log.scoped("AdvBarWindow")
    ...
    readonly property var dBarLayer: LayerShell.fromEnv("ADVS_ADVBAR_LAYER", barWindow.usesOverlayLayer ? WlrLayer.Overlay : WlrLayer.Top)

    screen: modelData
    color: "transparent"

    WlrLayershell.layer: dBarLayer
    WlrLayershell.namespace: "advs:bar"
