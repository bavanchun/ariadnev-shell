...
BasePill {
    ...
    readonly property var hiddenTrayIds: {
        const envValue = Quickshell.env("ADVS_HIDE_TRAYIDS") || "";
    ...
    // ! TODO - replace with either native dbus client (like plugins use) or just a ADVS cli or something
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "advs:tray-overflow-menu"
        color: "transparent"
    ...
    Component {
        ...
        Rectangle {
            ...
            PanelWindow {
                ...
                WlrLayershell.namespace: "advs:tray-menu-window"
