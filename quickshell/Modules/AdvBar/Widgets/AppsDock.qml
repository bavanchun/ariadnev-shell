                ...
                Rectangle {
                    ...
                    AppIconRenderer {
                        ...
                        iconValue: {
                            ...
                            if ((appId === "advs_settings" || appId === "advs_notepad" || appId === "advs_sysmon") && modelData.coreAppData.cornerIcon) {
                    ...
                    IconImage {
                        ...
                        layer.enabled: appItem.appId === "org.quickshell" || appItem.appId === "dev.vchun.ariadnev"
                        layer.smooth: true
                        layer.mipmap: true
                    ...
                    onClicked: mouse => {
                        if (mouse.button === Qt.RightButton) {
                            ...
                            if (contextMenuLoader.item) {
                                ...
                                const shouldHidePin = modelData.appId === "org.quickshell" || modelData.appId === "dev.vchun.ariadnev";
                                const moddedId = Paths.moddedAppId(modelData.appId);
