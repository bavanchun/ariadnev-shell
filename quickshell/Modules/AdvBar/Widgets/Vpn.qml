    ...
    content: Component {
        Item {
            ...
            AdvIcon {
                ...
                name: ADVSNetworkService.connected ? "vpn_lock" : "vpn_key_off"
                size: Theme.barIconSize(root.barThickness, -4, root.barConfig?.maximizeWidgetIcons, root.barConfig?.iconScale)
                color: ADVSNetworkService.connected ? Theme.primary : Theme.widgetIconColor
