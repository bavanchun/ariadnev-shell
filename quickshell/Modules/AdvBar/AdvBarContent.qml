...
import qs.Common
import qs.Modules.AdvBar.Widgets
import qs.Services
...
Item {
    ...
    function _resolvePopoutFromLoader(loader) {
        ...
        const pairs = [[PopoutService.appDrawerLoader, PopoutService.appDrawerPopout], [PopoutService.batteryPopoutLoader, PopoutService.batteryPopout], [PopoutService.clipboardHistoryPopoutLoader, PopoutService.clipboardHistoryPopout], [PopoutService.controlCenterLoader, PopoutService.controlCenterPopout], [PopoutService.advDashPopoutLoader, PopoutService.advDashPopout], [PopoutService.layoutPopoutLoader, PopoutService.layoutPopout], [PopoutService.notificationCenterLoader, PopoutService.notificationCenterPopout], [PopoutService.processListPopoutLoader, PopoutService.processListPopout], [PopoutService.systemUpdateLoader, PopoutService.systemUpdatePopout], [PopoutService.vpnPopoutLoader, PopoutService.vpnPopout], [PopoutService.colorPickerPopoutLoader, PopoutService.colorPickerPopout], [PopoutService.powerMenuPopoutLoader, PopoutService.powerMenuPopout]];
    ...
    Component {
        ...
        Clock {
            ...
            popoutTarget: PopoutService.advDashPopoutLoader?.item ?? null
            parentScreen: barWindow.screen
            ...
            onClockClicked: {
                ...
                topBarContent.openWidgetPopout({
                    loader: PopoutService.advDashPopoutLoader,
