...
var SPEC = {
    ...
    advLauncherV2Size: { def: "compact" },
    advLauncherV2ShowSourceBadges: { def: true },
    advLauncherV2BorderEnabled: { def: false },
    advLauncherV2BorderThickness: { def: 2 },
    advLauncherV2BorderColor: { def: "primary" },
    advLauncherV2ShowFooter: { def: true },
    advLauncherV2UnloadOnClose: { def: false },
    advLauncherV2IncludeFilesInAll: { def: false },
    advLauncherV2IncludeFoldersInAll: { def: false },
    ...
    runAdvsMatugenTemplates: { def: true },
    ...
    advIslandBarId: { def: "", onChange: "updateBarConfigs" },
    advIslandFloating: { def: false },
    advIslandUseOverlayLayer: { def: false },
    advIslandReserveHeight: { def: 40 },
    advIslandCompactHeight: { def: 38 },
    advIslandOuterGap: { def: 4 },
    advIslandHorizontalOffset: { def: 0 },
    advIslandInteractionMode: { def: "hybrid" },
    advIslandHoverOpenDelay: { def: 150 },
    advIslandHoverCloseDelay: { def: 150 },
    advIslandPalette: { def: "default" },
    advIslandTransparency: { def: 1 },
    advIslandHighContrast: { def: false },
    advIslandMediaClockVisible: { def: true },
    advIslandHomeNotificationBadge: { def: true },
    advIslandNotificationBadgeClearOnOpen: { def: false },
    advIslandNotificationExpand: { def: false },
    advIslandHomeMediaSlot: { def: "left" },
    advIslandHomeStatusSlot: { def: "hidden" },
    advIslandHomeWeatherSlot: { def: "hidden" },
    advIslandHomeCompactTight: { def: false },
    advIslandBatteryStyle: { def: "solid" },
    advIslandSatellitesEnabled: { def: true },
    advIslandSatellitePosition: { def: "edges" },
    advIslandSatelliteGap: { def: 12 },
    advIslandSatelliteBackground: { def: false },
    advIslandSatelliteGothCorners: { def: true },
    advIslandSatelliteTransparency: { def: 1 },
    advIslandSatelliteSwoopRadius: { def: 24 },
    advIslandReducedMotion: { def: false },
    advIslandSpringStiffness: { def: 560 },
    advIslandSpringDamping: { def: 37 },
    advIslandSpringMass: { def: 1 },
