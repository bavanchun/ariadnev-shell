...
Item {
    id: root
    readonly property var log: Log.scoped("AdvModalStandalone")
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: root.enableShadow && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("ADVS_DISABLE_LAYER") !== "true" && Quickshell.env("ADVS_DISABLE_LAYER") !== "1"
                    }
