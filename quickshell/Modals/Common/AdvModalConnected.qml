...
Item {
    id: root
    readonly property var log: Log.scoped("AdvModalConnected")

    property var modalHandle: root
    property string layerNamespace: "advs:modal"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: root.useOverlayLayer ? WlrLayer.Overlay : LayerShell.fromEnv("ADVS_MODAL_LAYER", WlrLayer.Top, {
            "allow": ["top", "overlay"],
                ...
                Item {
                    ...
                    Item {
                        ...
                        ElevationShadow {
                            ...
                            shadowEnabled: !root.frameOwnsConnectedChrome && root.enableShadow && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("ADVS_DISABLE_LAYER") !== "true" && Quickshell.env("ADVS_DISABLE_LAYER") !== "1"
                        }
