...
Item {
    ...
    readonly property var log: Log.scoped("AdvLauncherV2ModalIsland")
    readonly property var router: PopoutService.advIslandRouter
    ...
    function _openIsland(query, mode) {
        ...
        log.warn("No AdvIsland is routed to the focused screen; falling back to Spotlight");
        usingFallback = true;
        return false;
    }
