...
Item {
    id: root
    readonly property var log: Log.scoped("AdvLauncherV2ModalStandalone")
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "advs:spotlight:clickcatcher"
    ...
    PanelWindow {
        ...
        Item {
            ...
            ElevationShadow {
                ...
                shadowEnabled: Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("ADVS_DISABLE_LAYER") !== "true" && Quickshell.env("ADVS_DISABLE_LAYER") !== "1"
            }
