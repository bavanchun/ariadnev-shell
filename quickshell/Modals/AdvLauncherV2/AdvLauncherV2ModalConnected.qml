...
Item {
    id: root
    readonly property var log: Log.scoped("AdvLauncherV2ModalConnected")
    ...
    readonly property bool unloadContentOnClose: SettingsData.advLauncherV2UnloadOnClose
    ...
    readonly property var effectiveLauncherLayer: LayerShell.fromEnv("ADVS_MODAL_LAYER", root.usesOverlayLayer ? WlrLayer.Overlay : WlrLayer.Top, {
        "allow": ["top", "overlay"],
    ...
    readonly property color borderColor: {
        if (!SettingsData.advLauncherV2BorderEnabled)
            return Theme.outlineMedium;
        switch (SettingsData.advLauncherV2BorderColor) {
        case "primary":
    ...
    readonly property int borderWidth: SettingsData.advLauncherV2BorderEnabled ? SettingsData.advLauncherV2BorderThickness : 0
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "advs:spotlight"
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: !root.frameOwnsConnectedChrome && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("ADVS_DISABLE_LAYER") !== "true" && Quickshell.env("ADVS_DISABLE_LAYER") !== "1"
                    }
